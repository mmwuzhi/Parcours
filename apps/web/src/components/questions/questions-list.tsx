    ...
    <div style={{ padding: '24px 28px' }}>
      ...
      {showModal && (
        <Modal onClose={() => { setShowModal(false); reset() }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 20 }}>Add question</h2>
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <FormField label="Question *" error={errors.content?.message}>
              <textarea {...register('content')} placeholder="What is the question?" rows={3} style={{ ...inputStyle, resize: 'vertical' }} autoFocus />
            </FormField>
            <FormField label="Answer (optional)">
              <textarea {...register('answer')} placeholder="Your answer or notes…" rows={4} style={{ ...inputStyle, resize: 'vertical' }} />
            </FormField>
            <div style={{ display: 'flex', gap: 12 }}>
              ...
              <FormField label="Source company">
                <input {...register('sourceCompany')} placeholder="Google" style={inputStyle} />
              </FormField>
            </div>
